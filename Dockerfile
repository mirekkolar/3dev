...
#   - watcher         : converts edited .kicad_sch/.kicad_pcb files to .svg automatically
#
...
# --- App scripts and process manager config. ---
...
LABEL org.opencontainers.image.title="cadquery-kicad-dev" \
      org.opencontainers.image.description="Hardware-as-code dev image: CadQuery 3D models + KiCad schematics/PCB, with live web previews and an auto SVG-export watcher."
